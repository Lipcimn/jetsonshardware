...
public:
    ...
    uint32_t color; //This is needed because everytime a new text is printed, it does not replace the old one. It's necessary to print a box above the old text to "delete" it.
